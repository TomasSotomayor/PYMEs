...
if (currentTheme === 'light') {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--button-color)" class="bi bi-moon" viewBox="0 0 16 16" id="theme-toggle">
...
if (document.body.classList.contains('light-mode')) {
    ...
    toggleButton.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--button-color)" class="bi bi-sun" viewBox="0 0 16 16" id="theme-toggle">
